...
public class Skeleton : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.layer == LayerMask.NameToLayer("Bullet")) // Collision = 총알
        {
            ...
            tilemap.SetTile(cellPosition, _wall); // Skeleton 위치에 벽 생성

            Destroy(gameObject);
            Destroy(collision.gameObject);
        }

        //else if (collision.gameObject.layer == LayerMask.NameToLayer("Player")) // 일단 플레이어 사망
        //{
        //    Destroy(collision.gameObject);
        //}
    }
